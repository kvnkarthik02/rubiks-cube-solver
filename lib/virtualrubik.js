 ...
 */
function includeVirtualRubik(libURL, objURL, shaderURL) {
  
  document.write('<script type="text/javascript" src="'+libURL+'/webgl-utils.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/easywebgl.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/J3DIMath.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/splineinterpolator.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/node3d.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/cube.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/cube3d.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/cubeattributes.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/rubikscube.js"></script>');
  document.write('<script type="text/javascript" src="'+libURL+'/rubikscube3d.js"></script>');
  document.write('<script id="vshader" type="x-shader/x-vertex" src="'+shaderURL+'/phong.vshader"></script>');
  document.write('<script id="fshader" type="x-shader/x-fragment" src="'+shaderURL+'/phong.fshader"></script>');
  document.write('<script id="rubik_center" type="application/x-wavefront" src="'+objURL+'/rubik_center.obj"></script>');
  document.write('<script id="rubik_side" type="application/x-wavefront" src="'+objURL+'/rubik_side.obj"></script>');
  document.write('<script id="rubik_edge" type="application/x-wavefront" src="'+objURL+'/rubik_edge.obj"></script>');
  document.write('<script id="rubik_corner" type="application/x-wavefront" src="'+objURL+'/rubik_corner.obj"></script>');
  document.write('<script id="rubik_sticker" type="application/x-wavefront" src="'+objURL+'/rubik_sticker.obj"></script>');
}
...
VirtualRubik.prototype.moveRPrime = function() {  
  var axis = 2;
  var layerMask = 4;
  var angle = 1;
...
//function that the html calls for any moves to be made
VirtualRubik.prototype.makeMove = function(axis,layerMask,angle) {
  this.cube.transform(axis,layerMask,angle);
}
